...
class TwitterUsersControllerTest < ActionController::TestCase
  ...
  test "should create twitter_user" do
    assert_difference('TwitterUser.count') do
      post :create, twitter_user: { full_name: @twitter_user.full_name, screen_name: @twitter_user.screen_name, source_id: @twitter_user.source_id }
    end
  ...
  test "should update twitter_user" do
    put :update, id: @twitter_user, twitter_user: { full_name: @twitter_user.full_name, screen_name: @twitter_user.screen_name, source_id: @twitter_user.source_id }
    assert_redirected_to twitter_user_path(assigns(:twitter_user))
  end
